 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "Denetimli öğrenmede model girdi ve çıktı değişkenleri(etiketli veri) ile eğitilir. Amaç girdi özelliklerini çıktı ile eşleştirmek için uygun fonksiyonu bulmaktır. Algoritmaları:  linear regression, logistics regression, random forest. \n",
    "Denetimsiz öğrenmede model sadece girdi verileri(etiketsiz veri) ile eğitilir. Amaç veriler hakkında bilgi edinmek için dağılımı modellemektir. Algoritmaları: cluster algorithms, k-means, hierarchical clustering."
   ]
  },
  {
   "cell_type": "markdown",
